      ...
      <div className="relative">
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className={cn(
                "block max-h-[200px] min-h-20 w-full overflow-y-auto whitespace-pre-wrap break-words bg-transparent text-[17px] leading-relaxed text-foreground focus:outline-none sm:min-h-17.5 sm:text-[14px]",
                className,
              )}
          ...
          placeholder={
            terminalContexts.length > 0 ? null : (
              <div className="pointer-events-none absolute inset-0 text-[17px] leading-relaxed text-muted-foreground/35 sm:text-[14px]">
                {placeholder}
              </div>
            )
          }
